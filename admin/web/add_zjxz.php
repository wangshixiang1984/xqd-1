...
if(!isset($_SESSION[USER])){
	...
	if(isset($_POST["submit"])){
		...
		$sql="insert into jdjs (title,befrom,keyword,des,img_path,author,time,content,type) 
		values('$xcap_title','$xcap_befrom','$xcap_keyword','$xcap_des','$xcap_keypic','$xcap_author','$xcap_time','$xcap_content','$xcap_typeimg')";
