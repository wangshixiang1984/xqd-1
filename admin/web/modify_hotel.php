...
if(!isset($_SESSION[USER])){
	...
	if(isset($_POST["submit"])){
		...
		$sql="update hotel set title='$xcap_title',keyword='$xcap_keyword',des='$xcap_des',img_path='$xcap_keypic'
		,author='$xcap_author',price='$xcap_price',address='$address',city='$city' where id='$id'";
...
<table  style="width:100%;">
	<tbody>
		...
		<tr>
			<td ></td>
			<td >酒店名称：</td>
			<td><input type="text" name="title" id="title" style="width:300px; height:25px;" value="<?php echo $info['title'];?>" /><span id="pmsgt" style="color:#f00; font-size:12px;">*</span></td>
		</tr>
		...
		<tr>
			<td></td>
			<td >地址：</td>
			<td><input type="text" name="address"  style="height:25px;" value="<?php echo $info['address'];?>" /><span style="color:#f00; font-size:12px;"></span></td>
		</tr>
		<tr>
			<td></td>
			<td>所在城市：</td>
			<td><input type="text" name="city" value="<?php echo $info['city'];?>"  style="height:25px;" /></td>
		</tr>	
		<!-- <tr>
			<td></td>
			<td >主图尺寸：</td>
