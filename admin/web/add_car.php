...
if(!isset($_SESSION[USER])){
	...
	if(isset($_POST["submit"])){
		...
		$sql="insert into car (title,typed,keyword,des,img_path,author,price,brand,time,getaddress,backaddress,peizhi,
		peopleseat,days,content) 
		values('$xcap_title','$xcap_typed','$xcap_keyword','$xcap_des','$xcap_keypic','$xcap_author',
		'$xcap_price','$brand','$xcap_time','$getaddress', '$backaddress', '$peizhi', '$peopleseat','$days', '$orderinfo')";
...
<table  style="width:100%;">
	<tbody>
		...
		<tr>
			<td></td>
			<td >出租天数：</td>
			<td><input type="text" name="days"  style="height:25px;" /><span style="color:#f00; font-size:12px;"></span></td>
		</tr>
		<tr>
			<td></td>
			<td >品牌：</td>
			<td><input type="text" name="brand"  style="height:25px;" /><span style="color:#f00; font-size:12px;">丰田</span></td>
		</tr>
		<tr>
			<td></td>
			<td>类型：</td>
			<td><input type="text" name="typed"  style="height:25px;" /><span style="color:#f00; font-size:12px;">经济型</span></td>
		</tr>
		<tr>
			<td></td>
			<td>配置：</td>
			<td><input type="text" name="peizhi"  style="height:25px;" /></td>
		</tr>
		<tr>
			<td></td>
			<td>可乘人数：</td>
			<td><input type="text" name="peopleseat"  style="height:25px;" /></td>
		</tr>
		<tr>
			<td></td>
			<td>取车地点：</td>
			<td><input type="text" name="getaddress"  style="height:25px;" /></td>
		</tr>
		<tr>
			<td></td>
			<td>还车地点：</td>
			<td><input type="text" name="backaddress"  style="height:25px;" /></td>
		</tr>	
		<!-- <tr>
			<td></td>
			<td >主图尺寸：</td>
		...
		<tr>
			<td></td>
			<td >预订说明：</td>
			<td><textarea  name="orderinfo" style="width:500px; height:100px;"></textarea></td>
		</tr>
