...
if(!isset($_SESSION[USER])){
	...
	if(isset($_POST["adver_submit"])){
		...
		if($lg->imd($sql)){
			...
			$str_go=$lg->gopage("add_adver.php");
		}
	}
?>
...
<tbody>
	...
	<tr>
		<td><select name="adver_type">
				...
				<option <?php echo $arr_type[1];?> value="1">行程安排广告</option>
				<option <?php echo $arr_type[2];?> value="2">定制线路广告</option>
				<option <?php echo $arr_type[3];?> value="7">首页单版广告</option>
