...
if(!isset($_SESSION[USER])){
	...
	if(isset($_POST["submit"])){
		...
		if(!empty($xcap_keypic)){
			$sql="insert into tqlk (title,befrom,type,keyword,des,img_path,author,time,content)
			values('$xcap_title','$xcap_befrom','$xcap_type','$xcap_keyword','$xcap_des','$xcap_keypic','$xcap_author','$xcap_time','$xcap_content')";				
		}else $sql="insert into tqlk (title,type,befrom,keyword,des,author,time,content) 
		values('$xcap_title','$xcap_type','$xcap_befrom','$xcap_keyword','$xcap_des','$xcap_author','$xcap_time','$xcap_content')";
	...
	<tbody>
		<tr>
			...
			<br /><br />
				...
				类别：<select name="type"><option value="0">天气</option><option value="1">路况</option></select><br /><br />
