...
if(!isset($_SESSION[USER])){
	...
	if(isset($_POST["submit"])){
		...
		$sql="insert into hyzx (title,keyword,des,author,time,content) 
		values('$hyzx_title','$hyzx_keyword','$hyzx_des','$hyzx_author','$hyzx_time','$hyzx_content')";
