...
if(!isset($_SESSION[USER])){
	...
	$id=intval($_GET["id"]);
	$sql="select * from xcmw where id='$id'";
	...
	if(isset($_POST["submit"])){
		...
		$sql="update xcmw set title='$hysy_title',befrom='$hysy_befrom',keyword='$hysy_keyword',des='$hysy_des',img_path='$hysy_keypic'
		,author='$hysy_author',content='$hysy_content' where id='$id'";
