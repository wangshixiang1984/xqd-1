...
if(!isset($_SESSION[USER])){
	...
	if(isset($_POST["submit"])){
		...
		$xcapid=$_POST["xcapid"];
		$xcap_typeimg=$_POST["hysy_typeimg"];
		$sql="insert into hysy (title,keyword,befrom,des,img_path,author,time,content,type, xcapid) 
		values('$xcap_title','$xcap_keyword','$xcap_befrom','$xcap_des','$xcap_keypic','$xcap_author',
		'$xcap_time','$xcap_content','$xcap_typeimg', '$xcapid')";
	...
	<tbody>
		<tr>
			...
			<br /><br />
				...
				推荐行程ID：<input type="text" name="xcapid" style=" height:25px;"/> <br /><br />				
