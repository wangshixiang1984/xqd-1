...
if(!isset($_SESSION[USER])){
	...
	if(isset($_POST["submit"])){
		...
		$sql="insert into zjzx (title,befrom,keyword,des,author,time,content) 
		values('$hyzx_title','$hyzx_befrom','$hyzx_keyword','$hyzx_des','$hyzx_author','$hyzx_time','$hyzx_content')";
	...
	<tbody>
		<tr>
			...
			<br /><br />
				...
				来源：<input type="text" name="befrom" style=" height:25px;"/> <br /><br />
