...
if(!isset($_SESSION[USER])){
	...
	if(isset($_POST["submit"])){
		...
		$xcap_des=$_POST["des"];
		$sql="insert into xshd (time,content,title,des,keyword) 
		values('$xcap_time','$xcap_content','$xcap_title','$xcap_des','$xcap_keyword')";
		if($lg->imd($sql)){
...
<table  style="width:100%;">
	<tbody>
		<tr>
			...
			描述:<textarea name="des" rows="4" cols="50"></textarea><br /><br />
