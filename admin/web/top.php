        ...
        <td width="281" valign="bottom"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="248" background="images/main_06.gif"><table width="225" border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td height="17"><div align="right"><a href="psw_modify.php" target="right"><img src="images/pass.gif" width="69" height="17" /></a></div></td>
                <td><div align="right"><img src="images/user.gif" width="69" height="17" /></div></td>
                <td><div align="right"><a href="log_out.php" target="_parent"><img src="images/quit.gif" width="69" height="17" /></a></div></td>
              </tr>
            </table></td>
          </tr>
        </table></td>
      ...
      <tr>
        ...
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="35" class="STYLE7"><div align="center"><a href="../../index.php" target="_blank">首页</a></div></td>
        ...
        <td width="248" background="images/main_11.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="75%"><div align="center"><span class="STYLE7">服务器时间：<?php echo date("Y-m-d",time());?></span></div></td>
            <td width="9%">&nbsp;</td>
          </tr>
        </table></td>
      </tr>
  ...
  <tr>
    <td height="30" background="images/main_31.gif"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="20" valign="bottom"><span class="STYLE1">当前登录用户：<?php echo $_SESSION[USER];?> &nbsp;用户角色：管理员</span></td>
            <td valign="bottom" class="STYLE1"><div align="right"><img src="images/sj.gif" width="6" height="7" /> IP：<?php echo $_SERVER["REMOTE_ADDR"]?>       &nbsp; &nbsp;&nbsp;<img src="images/sj.gif" width="6" height="7" /> &nbsp;提供商：成都慧萌 &nbsp; &nbsp; <img src="images/sj.gif" width="6" height="7" /> &nbsp;单位：心启点自驾游俱乐部</div></td>
          </tr>
        </table></td>
