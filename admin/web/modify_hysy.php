...
if(!isset($_SESSION[USER])){
	...
	$id=intval($_GET["id"]);
	$sql="select * from hysy where id='$id'";
	...
	if(isset($_POST["submit"])){
		...
		$sql="update hysy set title='$hysy_title',befrom='$hysy_befrom',keyword='$hysy_keyword',des='$hysy_des',img_path='$hysy_keypic'
		,author='$hysy_author',content='$hysy_content',xcapid='$xcapid' where id='$id'";
		if($lg->imd($sql)){
...
<table  style="width:100%;">
	<tbody>
		<tr>
			...
			<div style="text-align:right"><a href="man_hysy.php">往上一级</a></div>
			<br /><br />
				...
				推荐行程ID：<input type="text" name="xcapid" style=" height:25px;" value="<?php echo $hysy_arr1["xcapid"];?>"/> <br /><br />			
