...
<footer class="footer p10 clr-all relative">
    <div class="mt40">
        ...
        <div class="mod1">
                ...
                <p  class="t-c mt5">
                    <i style="width: 0.2rem; height: 0.2rem;" id="gotel" phone="<?php echo $tels['zxtel']; ?>">
        ...
        <div class="mod1">
            <p  class="t-c mt5">
                <i style="width: 0.2rem; height: 0.2rem;" id="gotel" phone="<?php echo $tels['tstel']; ?>">
                <img src="/h5/public/images/tel.png" /></i>
                    手机：
                <?php echo $tels['zxtel']; ?> 
            </p>
        ...
        <div style="width: 80%; margin: 0 auto;" >
            <div class="mod p0">
            <i style="width: 0.2rem; height: 0.2rem;" id="gotel" phone="<?php echo $tels['xstel']; ?>">
            <img src="/h5/public/images/adr.png" /></i>
                <div  class="mt5">
